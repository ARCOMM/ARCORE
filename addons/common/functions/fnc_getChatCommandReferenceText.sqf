...
parseText (([
    ...
    "Eg. #radio 343</t>",
    "",
    "<t size='1.25' color='#f9c600'>Teleport</t>",
    "<t size='0.88' underline='true'>#tp &lt;group/player&gt;</t>",
    "<t size='0.66'>Will teleport you to the given group or player.",
    "Eg. #tp a1 or #tp krijger</t>",
    "",
