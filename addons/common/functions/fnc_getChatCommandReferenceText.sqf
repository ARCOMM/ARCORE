...
parseText (([
    ...
    "<t size='0.88'>#loadout krijger</t>",
    "<t size='0.88'>#loadout krijger wireless</t>",
    "",
    "<t size='1' color='#f9c600'>Radio - #radio (type)</t>",
    "<t size='0.88'>#radio 343</t>",
    "",
    "<t size='1' color='#f9c600'>Heal - #heal</t>",
    "<t size='1' color='#f9c600'>Heal - #heal (player)</t>",
    "<t size='0.88'>#heal</t>",
    "<t size='0.88'>#heal krijger</t>",
    "",
    "<t size='1' color='#f9c600'>Reset Position - #rp</t>",
    "<t size='0.88'>#rp</t>",
    "",
    "<t size='1' color='#f9c600'>Teleport - #tp (player|group)</t>",
    "<t size='0.88'>#tp krijger</t>",
    "<t size='0.88'>#tp a1</t>",
    "",
    ...
    "<t size='0.88'>#whisper krijger hello how you doing please help me</t>",
    "",
