...
def main():
    ...
    print("""
  ######################################
  # ARCORE3 Development Environment Setup #
  ######################################

  This script will create your ARCORE3 dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your ARCORE3 project folder:
    [Arma 3 installation directory]\\{} => ARCORE3 project folder
    P:\\{}                              => ARCORE3 project folder
